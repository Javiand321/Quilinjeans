...
export default function ProductClient() {
  ...
  const shareText = `Mira este increíble producto de Quilin Jeans: ${product.name}`;
          ...
          <div className="flex flex-col justify-center">
            ...
            <div className="flex gap-4 mb-8">
              ...
              <button 
                ...
                className="w-14 h-14 flex items-center justify-center rounded-full border border-gray-200 text-gray-400 hover:text-pink-500 hover:border-pink-500 transition-all"
                title="Copiar enlace"
              >
                <Share2 size={20} />
              </button>
